...
**Статус:** задача 0008 прийнята; відкритих задач немає
**Оновлено:** 2026-07-26

## Фокус зараз

**Наступний крок — закрити біт3 `HELLO`.** Асистент додав його в специфікацію
при прийманні 0008, тобто **після** написання коду, тож зараз документ і код
розходяться: `hello.cpp` біт не виставляє, а клієнт його не читає й запасного
шляху не має. Наслідок сьогодні нульовий (прошивка й клієнт обидва наші й
обидва нові), але біт вводився саме заради автора моста — закрити до етапу 2.
Обсяг маленький, задачі, найімовірніше, не потребує.
...
**Код у `firmware/edgetx-patch/remote_ui/`** — 95 тестів, нуль динамічної
пам'яті, нуль специфіки TX16S (ті самі тести проходять на 320×240, **212×64**
і 800×480). Як зібрати й прогнати — `remote_ui/README.md`. У клієнті — 61 тест
(`tools/proto_test.py`).

**Гачків у чужих файлах — 47 рядків у чотирьох місцях** (пункти 5, 6, 7, 8
