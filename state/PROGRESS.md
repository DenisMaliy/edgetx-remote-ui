...
**Етап:** 1 — розробка в симуляторі, крок 1.4 закрито
**Статус:** задача 0005 прийнята; наступне — крок 1.5, задачі ще немає
**Оновлено:** 2026-07-26

## Фокус зараз

**Наступне — крок 1.5: тестовий клієнт із вікном** (`tools/test_client.py`)
замість PNG. Протокол, транспорт і заміри вже готові — лишається показувати
кадр у вікні й тримати з'єднання живим. Задачу пише асистент.
