...
**Етап:** 2 — залізо. Крок 2.6 **закрито стендом**: фази 0–4 пройдені
**Статус:** задача 0012 виконана, чекає на рецензію; 0011 закривається нею
**Оновлено:** 2026-08-01
...
Задача [0012](../tasks/0012-bringup-bench.md): стенд піднято під наглядом
людини, **ворота A і B пройдені повністю**, з воріт C знято п'ять критеріїв
із шести.
