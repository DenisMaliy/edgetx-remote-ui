...
**Етап:** 1 — розробка в симуляторі, кроки 1.4 і 1.5 закрито
**Статус:** задача 0006 прийнята; у роботі — [0007](../tasks/0007-input-emulation.md), крок 1.6
**Оновлено:** 2026-07-26

## Фокус зараз

**Наступне — задача [0007](../tasks/0007-input-emulation.md): емуляція вводу**
(клавіші → енкодер → сенсор). Це останній крок етапу 1 і його критерій виходу:
повністю керувати симулятором із клієнта, включно з меню Lua-скрипта. Разом із
нею йде **борг із 0006 — `FRAME_END` після `REFRESH` у прошивці**.
