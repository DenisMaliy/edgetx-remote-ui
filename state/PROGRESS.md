...
**Етап:** 2 — залізо. Кроки 2.1–2.5 зроблені, лишився 2.6; крок 1.7 відкладено
**Статус:** задача 0010 **прийнята**. Наступна — 0011, міст ESP32
**Оновлено:** 2026-07-26
...
- [ ] Етап 2 — перенесення на залізо (кроки 2.1–2.5 зроблені, лишився 2.6 — міст ESP32)
