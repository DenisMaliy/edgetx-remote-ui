...
#### 10. Що лишилось незробленим

- [ ] **Меню Lua-скрипта ELRS із живим модулем.** Скрипт `ExpressLRS` на
      картці видно (вкладка Apps), але для чесної перевірки потрібен
      під'єднаний і живий модуль. Не робилось.
- [ ] **Фізичне висмикування дроту посеред сеансу.** Програмний еквівалент
      (обрив без пакета «відпущено») перевірений і пройдений; висмикування
      руками — ні.
